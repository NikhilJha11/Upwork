...
def detectDisease(values):
    ...
    for i in values:
        ...
        if j in val_list:
            ...
            print(key_list[position]==position)
            xp.append(key_list[position])
    say("You entered")
    for i in new_val:
        say(f'{i}')
    print(new_val)
...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            print("Recognizing...")
            query = r.recognize_google(audio, language="en-in,ml-in")
...
if __name__ == '__main__':
    print('Welcome to Beymax')
    say("Welcome to beymax")
